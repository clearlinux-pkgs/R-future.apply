...
Version  : 1.9.1
Release  : 7
URL      : https://cran.r-project.org/src/contrib/future.apply_1.9.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/future.apply_1.9.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662569343
