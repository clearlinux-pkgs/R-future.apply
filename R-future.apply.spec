...
Version  : 1.9.0
Release  : 6
URL      : https://cran.r-project.org/src/contrib/future.apply_1.9.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/future.apply_1.9.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650991942
