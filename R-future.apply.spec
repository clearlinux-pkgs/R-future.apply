...
Version  : 1.11.3
Release  : 19
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/future.apply_1.11.3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/future.apply_1.11.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731642378
